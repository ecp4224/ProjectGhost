...
namespace Ghost
{
    public abstract class Entity : Sprite, ILogical
    {
        ...
        public void InterpolateTo(float x, float y, float duration)
        {
            ...
            inter_startX = X;
            inter_startY = Y;
            inter_timeStart = Environment.TickCount;
        ...
        public virtual void Update()
        {
            ...
            {
                X = MathUtils.Ease(inter_startX, inter_targetX, inter_timeTakes, Environment.TickCount - inter_timeStart);
                Y = MathUtils.Ease(inter_startY, inter_targetY, inter_timeTakes, Environment.TickCount - inter_timeStart);
