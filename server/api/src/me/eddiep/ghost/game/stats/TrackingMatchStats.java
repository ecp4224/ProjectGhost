...
import static me.eddiep.ghost.utils.Constants.SECONDS_PER_TICK;
...
public class TrackingMatchStats {
    ...
    public static class FinalizedMatchStats {
        ...
        private FinalizedMatchStats(TrackingMatchStats stats) {
            if (stats.player instanceof BaseNetworkPlayer)
                this.playerId = ((BaseNetworkPlayer)stats.player).getPlayerID();
            else
                this.playerId = 0;
