...
public class MatchFactory {
    ...
    public static Match createMatchFor(Player player1, Player player2, QueueType queue) throws IOException {
    ...
    public static Match createMatchFor(Team team1, Team team2, QueueType queue) throws IOException {
