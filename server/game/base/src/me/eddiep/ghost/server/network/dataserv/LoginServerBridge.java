...
public interface LoginServerBridge {
    ...
    /**
     * Request that the login server saves the following match
     * @param match The match object to save
     * @return The match's ID if it was saved successfully, otherwise -1
     */
    public long saveMatchHistory(Match match);
}
