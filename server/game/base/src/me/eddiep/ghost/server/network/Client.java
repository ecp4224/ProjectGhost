...
public class Client {
    ...
    private class Writer extends Thread {
        ...
        public void run() {
            if (player != null) {
                Thread.currentThread().setName("Client-" + player.getSession() + "-Writer");
            } else {
                Thread.currentThread().setName("Client-CentralServer-Writer");
            }
    ...
    private class Reader extends Thread {
        ...
        public void run() {
            if (player != null) {
                Thread.currentThread().setName("Client-" + player.getSession() + "-Reader");
            } else {
                Thread.currentThread().setName("Client-CentralServer-Reader");
            }
